...

{
    ...
    description: `💻 Windows 10 Pro লাইসেন্স কী – আজীবনের জন্য এক্টিভেশন!
100% জেনুইন Microsoft Activation Key. ইমেইলে ডেলিভারি, রিমোট সাপোর্ট সহ। একবার এক্টিভ করলে আজীবন ব্যবহার করুন। Windows 10 থেকে 11-এ আপগ্রেড করলেও অটো এক্টিভ থাকবে।`,
    longDescription: `আজীবনের এক্টিভেশন


✅ আপনি যা পাচ্ছেন:

🔹 Microsoft Windows 10 Pro-এর অফিশিয়াল Activation Key
🔹 "Activate Windows" মেসেজ রিমুভ হবে – ফুল ফিচার আনলক
🔹 আজীবনের জন্য পার্মানেন্ট এক্টিভেশন (শুধুমাত্র ১টি পিসির জন্য)
🔹 ইমেইলে সরাসরি ডেলিভারি – কোনো DVD/পেনড্রাইভ নয়


🔧 এক্টিভেশন প্রসেস:

✔ নতুন করে Windows ইনস্টল না দিয়েও কী দিয়ে এক্টিভ করা যাবে
✔ Settings > Activation > Change product key – এখানে কী বসালেই এক্টিভ
✔ Windows রিসেট দিলে পুনরায় কী দিয়ে এক্টিভ করা যাবে


🖥️ শুধুমাত্র Windows 10-এর জন্য:

⚠️ এই কী শুধু Windows 10 Pro ভার্সনে কাজ করবে
⚠️ আপনি যদি Windows 10 থেকে Windows 11-এ অফিশিয়ালি আপগ্রেড করেন, তাহলে কী অটো এক্টিভ থাকবে


📩 ডেলিভারি তথ্য:

📧 অর্ডার করার ১০–৩০ মিনিটের মধ্যে আপনার ইমেইলে পাঠানো হবে:
• Activation Key
• এক্টিভেশন টিউটোরিয়াল
• Windows 10 ISO লিংক

🕘 সাপোর্ট টাইম: সকাল ১০টা – রাত ১২টা
🕚 রাত ১২টার পর অর্ডার করলে, পরদিন সকাল ১০টার পর ডেলিভারি দেওয়া হবে

❗ ডেলিভারি দেরি হলে WhatsApp সাপোর্টে যোগাযোগ করুন
👉 https://wa.me/8801645431905


🛠️ সাপোর্ট ও হেল্প:

🖥️ এক্টিভেশন সমস্যায় আমরা রিমোট সাপোর্ট দিয়ে থাকি
⚠️ নতুন করে Windows সেটআপ লাগলে, ক্লায়েন্ট নিজ দায়িত্বে ইনস্টল করবেন – আমরা ISO লিংক দিয়ে সহায়তা করব


🛡️ গ্যারান্টি ও রিফান্ড:

🔒 একবার এক্টিভ করলে আজীবন কাজ করবে
🔒 হার্ডওয়্যার পরিবর্তন না করলে সমস্যা হবে না
🔒 ১ বছরের রিফান্ড গ্যারান্টি (শর্ত প্রযোজ্য)`,
    category: "subscription",
    price: 0,
    image: "product_images/WINDOWS10.png",
    isFeatured: false,
    durations: [
        { label: `LIFETIME`, price: 399 }
    ]
},
// ⬇️ Add new product object below this line, inside the array ⬇️
...

{
    ...
    description: `💻 Windows 11 Pro লাইসেন্স কী – 100% জেনুইন ও আজীবনের এক্টিভেশন!
...
🔹 Microsoft Windows 11 Pro-এর অফিশিয়াল Activation/Product Key
...
🔒 ১ বছরের রিফান্ড গ্যারান্টি (শর্ত প্রযোজ্য)`,
    category: "subscription",
    price: 0,
    image: "product_images/WINDOWS11.png",
    isFeatured: false,
    durations: [
        { label: `LIFETIME`, price: 499 }
    ]
},
// ⬇️ Add new product object below this line, inside the array ⬇️
        ...
        function generateCategoryCards() {
            ...
            categories.forEach(category => {
                ...
                categoryCard.setAttribute('onclick', `navigateTo('products', '${category.name.toLowerCase()}')`);

                const iconWrapper = document.createElement('div');
                iconWrapper.className = 'category-icon-wrapper';
                const icon = document.createElement('i');
                icon.className = `${category.icon} category-icon-fa`;
                ...
                categorySubtitle.className = 'category-subtitle';
                categorySubtitle.id = `category-count-${category.name.toLowerCase()}`;

                // The count will be updated later by updateCategoryCountsInDOM
                const count = allProductsData.filter(p => p.category === category.name.toLowerCase()).length;
                categorySubtitle.textContent = `${count} ${category.subtitle}`;


                categoryCard.appendChild(iconWrapper);
                categoryCard.appendChild(categoryName);
                categoryCard.appendChild(categorySubtitle);
